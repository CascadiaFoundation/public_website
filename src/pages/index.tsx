      ...
      <div className='m-auto md:px-10 lg:px-32'>
        <div className='mt-12 grid grid-cols-1 gap-10 sm:mt-24 sm:grid-cols-2 lg:grid-cols-4'>
          ...
          <div className='flex flex-col p-6 md:p-0'>
            ...
            <Btn
              ...
              className='border-primary-900 bg-transparent text-primary-900'
            />
          </div>
          <div className='flex flex-col p-6 md:p-0'>
            <div className='home-content-base uppercase sm:text-left'>
        ...
        <div className='relative mt-24 grid-cols-4 gap-x-10 p-6 md:p-0 lg:grid'>
          <div className='col-span-2 p-6 md:p-0 lg:col-start-3'>
            ...
            <Btn
              ...
              className='w-full bg-primary-900 text-secondary-200 sm:w-fit'
            />
          </div>
          <div className='col-span-3 col-start-2 mt-8 hidden grid-cols-3 gap-3 bg-white p-6 md:gap-6 lg:grid'>
            {cardList.map((item) => (
        ...
        <div className='my-24 gap-x-10 p-6 text-center md:p-0'>
          ...
          <div className='relative mx-auto mb-6 flex h-10 w-full items-center border border-main-900 bg-transparent sm:w-1/2 lg:w-1/3'>
            ...
            />
            <input
              className='h-full w-full p-2 pl-10 placeholder-shown:hidden focus:outline-none md:placeholder:text-primary-500'
