          ...
          {[
            ...
            if (chainId === key) {
              return (
                <div
                  key={i}
                  className='border-purple flex w-full cursor-default items-center gap-4 rounded border bg-[rgba(0,0,0,0.2)] px-4 py-3 focus:outline-none'
                >
                  <Image
            ...
            return (
              <button
                ...
                className={clsx(
                  'border-dark-700 hover:border-blue flex w-full items-center gap-4 rounded border bg-[rgba(0,0,0,0.2)] px-4 py-3 focus:outline-none'
                )}
              >
                {/*@ts-ignore TYPE NEEDS FIXING*/}
                <Image
